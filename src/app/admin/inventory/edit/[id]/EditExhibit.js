...
export default function EditExhibit({ car }) {
  ...
  const handleSubmit = async (e) => {
    ...
    // Formatting data for Prisma Update (Including parseFloat fix)
    const dataToSend = { 
      ...formData,
      images,
      video: videoObj?.url || "",
            ...
            <div className="space-y-6 w-full box-border">
              ...
              <div className="grid grid-cols-2 gap-4 w-full box-border">
                ...
                <div className="space-y-2 font-geist-mono w-full overflow-hidden">
                  ...
                  <select name="scale" value={formData.scale} onChange={handleChange} className="w-full bg-white/5 border border-white/10 p-4 text-xs outline-none uppercase italic text-white appearance-none rounded-lg box-border">
